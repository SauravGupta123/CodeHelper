  ...
  return (
    <div className="prose prose-invert max-w-none">
      <ReactMarkdown 
        ...
        components={{
          h1: ({ children }) => <h1 className="text-2xl font-bold text-blue-300 mb-3">{children}</h1>,
          h2: ({ children }) => <h2 className="text-xl font-bold text-blue-300 mb-2">{children}</h2>,
          h3: ({ children }) => <h3 className="text-lg font-bold text-blue-300 mb-2">{children}</h3>,
          ...
          ul: ({ children }) => <ul className="list-disc list-inside space-y-1 mb-3 text-vscode-text">{children}</ul>,
          ol: ({ children }) => <ol className="list-decimal list-inside space-y-1 mb-3 text-vscode-text">{children}</ol>,
