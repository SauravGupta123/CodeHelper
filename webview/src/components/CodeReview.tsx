        ...
        <div className="text-center py-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 max-w-md mx-auto">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-blue-700">
                <p className="font-medium">Before starting analysis:</p>
                <p>Make sure you have set your Gemini API key in the extension settings.</p>
                <p className="mt-1">Use Command Palette: <code className="bg-blue-100 px-1 rounded">CodeHelper: Set Gemini API Key</code></p>
              </div>
            </div>
          </div>
          ...
          {isAnalyzing && (
            <div className="mt-4 text-sm text-gray-600">
              <p>This may take a few moments. The analysis will review your code for:</p>
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>Potential bugs and error handling</li>
